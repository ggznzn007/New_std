...
namespace _DateTimeStr
{
    class Pro
    {
        static void Main(string[] args)
        {
            DateTime date1 = new DateTime(1992, 7, 22, 8, 44, 0);
            DateTime date2 = new DateTime(1988, 7, 06, 8, 44, 0);
