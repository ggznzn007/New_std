...
public class BulletPool : MonoBehaviourPun // 싱글 플레이 풀방식
{
    ...
    private readonly Queue<GameObject> poolQueue = new Queue<GameObject>();    // 큐   방식
    ...
    public void Allocate()
    {
        ...
        {
            GameObject allocateBull = PN.Instantiate(poolBullet.name, transform.position,transform.rotation);           
            allocateBull.GetComponent<PhotonView>().RPC("SetActiveRPC", RpcTarget.All, false);
