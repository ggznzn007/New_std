...
public class ReadySceneManager2 : MonoBehaviourPunCallbacks                               // StartScene 스크립트
{
    public static ReadySceneManager2 readySceneManager2;                                          // 싱글턴
    ...
    private void Awake()
    {
        if (readySceneManager2 != null && readySceneManager2 != this)
        {
            Destroy(this.gameObject);
        }
        readySceneManager2 = this;
    ...
    public override void OnLeftRoom()
    {
        ...
        SceneManager.LoadScene("snowcraft");
        // Debug.LogError("방을 나갔습니다.");
